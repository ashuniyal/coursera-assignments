...
function RoutesConfig($stateProvider, $urlRouterProvider, $qProvider){
	...
	.state('categories',{
		url: "/categories",
		templateUrl: "/coursera-assignments/mod4-solution/template/routes-categories.html",
	...
	.state('categories.itemDetail',{
		...
		templateUrl: "/coursera-assignments/mod4-solution/template/routes-items.html",
